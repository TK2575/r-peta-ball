...
team_projections_2021 %>% 
  write_csv(here::here("out", "team_projections_2021_raw.csv"))

```

Normalize all RS/RA to last year's environment of total runs
```{r}
...
Calculate expected wins via Pythagorean theorem
```{r}
ex <- 1.83
...
team_projections_2021 %>% 
  ...
  write_csv(here::here("out", "team_projections_2021.csv"))
```
...
running_adjustments <- 
  apply_adjustments(running_adjustments, step2)
...
step3 <-
  ...
  select(tm, r_running_adj, ra_running_adj, war, g, war_proj, war_adj, war_diff, wp_diff, pyth_old, r_exponent, r, ra_exponent, ra) %>% 
  select(tm, r, ra)
...
running_adjustments <- 
  apply_adjustments(running_adjustments, step3)

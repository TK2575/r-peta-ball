...
# TODO residual plot to evaluate our model error
...
# TODO similar linear and residula plots as above comparing vegas odds and our projections

# TODO consider absolute value?
odds_comparison %>% 
  filter(abs(diff) > 4) %>% 
